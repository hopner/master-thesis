...
\hyperref[semunder]{SEMUNDER} was the only category with negative \gls{irr}-coefficients, this was marked preserved once by each of the coders on different participants. Both of these were declared resolved in the consensus, but were not picked up by both coders due to some ambiguity in regards to wether the the given statements were sufficient to show proper understanding. For instance:
\begin{quote}
...
\end{quote}
Other than these two categories, the disagreements were mostly due to missing a specific phrasing or interpreting a specific phrasing as not sufficient to mark the category as resolved. 

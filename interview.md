# Forhåndsintervju LLM-explainer


### Forklar med egne ord hva AI er og hvordan det fungerer
- Etter dette spørmålet skal AI i denne sammenhengen være forstått som LLMs, og ikke AI generelt.
- Dersom det er naturlig, still konkrete oppfølgingsspørmål for å dekke DETAUTOM, CONTEXNEG, TOKENNEG.
...
### Hvordan påvirker LLMs samfunnet generelt, både nå og i fremtiden?
- Prøv å få vedkommende til å sammenlikne en student før og etter LLMs, og hvordan det har påvirket deres studiehverdag.
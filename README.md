...
| Label | Code | Definition | Examples |
| --- | --- | --- | --- |
| Replacement Fear | REPLFEAR | Belief that LLMs will replace human roles or professions | "AI will replace ..." |
| Cognitive Passivity | COGPASS | Tendency to rely on LLMs rather than engaging in independent reasoning | Need to be added |
| Dependency Risk | DEPRISK | Concern or recognition that users may become reliant on LLMs | Need to be added |
| Credibility Bias | CREDBIAS | Treating LLM outputs as inherently truthful or authoritative | "If it says it, it is probably true" |